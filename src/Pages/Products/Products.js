...
import {
  ...
  ApiKategory,
  ApiKategoryGet,
} from "../../Config/Redux/Action/Products";
import {
  MDBCard,
  MDBCardImage,
  MDBCardBody,
...
const Products = () => {
  ...
  useEffect(() => {
    ...
    KategoryId
      ? ApiKategoryGet(KategoryId, queryPage, setPageNum, setProject)
      : ApiProductsGetQuery(queryPage, setPageNum, setProject);
    //!tutup
  ...
  const DeleteProducts = (data) => {
    if (window.confirm("Delete Products"))
      axios
        .delete(
          `https://d4608642-6ba1-4fc1-b625-fc9fc8fcd476-00-qmjm9kj9xpab.picard.replit.dev/Products/v1/deleteById/${data}`
        )
        .then((res) => {
              ...
              <>
                ...
                >
                  <Container className="d-flex align-items-center">
                    ...
                    <Navbar.Brand className="d-flex flex-wrap mb-1">
                      <Nav.Link href="https://wa.me/628561704782">
                        <svg
                          width="20"
                          height="20"
                          fill="currentColor"
                          className="bi bi-whatsapp me-2 icon_nav"
                          viewBox="0 0 16 16"
                        >
                      ...
                      <Nav.Link href="https://www.instagram.com/bunda_hafifah/">
                        <svg
                          width="20"
                          height="20"
                          fill="currentColor"
                          className="bi bi-instagram me-2 icon_nav"
                          viewBox="0 0 16 16"
                        >
                      ...
                      <Nav.Link href="https://shopee.co.id/fahrian413">
                        <svg
                          width="20"
                          height="20"
                          fill="currentColor"
                          className="bi bi-bag-fill me-2 icon_nav"
                          viewBox="0 0 16 16"
                        >
              ...
              return (
                <MDBCol key={data._id}>
                  ...
                  >
                    ...
                    >
                      <MDBCardImage
                        src={`https://d4608642-6ba1-4fc1-b625-fc9fc8fcd476-00-qmjm9kj9xpab.picard.replit.dev/${Products.image}`}
                        alt="..."
                        position="top"
                      />
                      <MDBCardBody>
                        <MDBCardTitle className="card_title">
                          {Products.Title}
                        </MDBCardTitle>
                    ...
                    {Random ? <UpdateModal dataOld={data} /> : false}
                  </MDBCard>
                </MDBCol>
              );
            })}
                ...
                <MDBPagination circle className="mb-0">
                  <MDBPaginationItem>
                    <MDBPaginationLink
                      ...
                      onClick={() => {
                        setQueryPage(
                          queryPage === 1 ? queryPage : queryPage - 1
                        );
                      }}
                    >
                      Previous
          ...
          <Modal show={show} centered onHide={handleClose}>
            ...
            >
              <Modal.Title
                ...
                style={{ fontSize: "24px", marginLeft: "45%", color: "white" }}
              >
                {modal.Title}
              </Modal.Title>
            </Modal.Header>
              ...
              <div className="body_modal d-flex justify-content-center align-items-center">
                <Figure>
                  <Figure.Image
                    ...
                    alt="171x180"
                    src={`https://d4608642-6ba1-4fc1-b625-fc9fc8fcd476-00-qmjm9kj9xpab.picard.replit.dev/${modal.image}`}
                  />
                </Figure>
                <div className="m-2 ">
                  <div
