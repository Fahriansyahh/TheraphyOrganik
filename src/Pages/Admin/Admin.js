      ...
      <Row className="d-flex justify-content-center align-items-center">
        ...
        >
          <Form
            ...
            className=" d-flex justify-content-center align-items-center  flex-column me-3 ms-3 p-3 "
          >
            ...
            >
              ...
              <div className="d-flex justify-content-center align-items-center ">
                <Button
                  ...
                  style={{ width: "max-context" }}
                  className="m-auto mt-2 pe-5 ps-5"
                  onClick={() => {
                    history("/");
                  }}
                >
                ...
                <Button
                  variant="outline-success Btn_bgc"
                  style={{ width: "max-context" }}
                  className="m-auto mt-2 pe-5 ps-5"
                  onClick={() => {
                    AdminValue();
